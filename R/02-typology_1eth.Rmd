...
par(mfrow=c(1,2))
pplot(croparea_imp~survey, eth[croparea_4ha=="<= 4 ha"],
...
par(mfrow=c(1,2))
pplot(100*cropsales_sh~croparea_4ha+survey, eth,
...
pplot(100*agsales_sh~croparea_4ha+survey, eth,
...
pplot(100*naggross_sh~croparea_4ha+survey, eth,
...
plot(svytable(~croparea_3clas+class9, eth.svy[["eth2"]]), main=NA, las=1, col=viridis(9),
  ylab=NA, xlab="Typology 9-class (2013/14)")
plot(svytable(~croparea_3clas+class9, eth.svy[["eth1"]]), main=NA, las=1, col=viridis(9),
...
# ESS3
tmp <- svymean(~I(interaction(croparea_3clas, cropsales_3clas, naggross_3clas)), eth.svy.farm[["eth3"]], na.rm=T)
tmp.cv <- confint(tmp)
...
tmp[, `:=`(
  croparea_3clas = factor(rep(levels(eth$croparea_3clas), each=1, 9), levels=c("<= 2 ha", "2-4 ha", "> 4 ha")),
  cropsales_3clas = factor(rep(levels(eth$cropsales_3clas), each=3, 3), levels=c("LoC", "MeC", "HiC")),
  naggross_3clas = factor(rep(levels(eth$naggross_3clas), each=9, 1), levels=c("LoD", "MeD", "HiD"))
  )]
...
# ESS2
tmp <- svymean(~I(interaction(croparea_3clas, cropsales_3clas, naggross_3clas)), eth.svy.farm[["eth2"]], na.rm=T)
tmp.cv <- confint(tmp)
tmp <- cbind(as.data.table(tmp*100), as.data.table(tmp.cv*100))
tmp[`2.5 %`<0, `2.5 %` := 0]
tmp <- tmp[, lapply(.SD, function(x) format(x, digits=0, nsmall=1, scientific=F))]
...
# ERSS1
tmp <- svymean(~I(interaction(croparea_3clas, cropsales_3clas, naggross_3clas)), eth.svy.farm[["eth1"]], na.rm=T)
tmp.cv <- confint(tmp)
tmp <- cbind(as.data.table(tmp*100), as.data.table(tmp.cv*100))
tmp[`2.5 %`<0, `2.5 %` := 0]
tmp <- tmp[, lapply(.SD, function(x) format(x, digits=0, nsmall=1, scientific=F))]
...
tmp1 <- lapply(eth.svy.shf, function(x) {
  ...
  tmp[, CI := paste(`2.5 %`, `97.5 %`, sep=" - ")]
  tmp[, `:=`(
    cropsales_3clas = factor(rep(levels(eth$cropsales_3clas), 3), levels=c("LoC", "MeC", "HiC")),
    naggross_3clas = factor(rep(levels(eth$naggross_3clas), each=3, 1), levels=c("LoD", "MeD", "HiD"))
  )]
})
tmp <- rbindlist(tmp1)
...
# ESS3
tmp <- svymean(~I(interaction(croparea_3clas, class5)), eth.svy.farm[["eth3"]], na.rm=T)
tmp.cv <- confint(tmp)
tmp <- cbind(as.data.table(tmp*100), as.data.table(tmp.cv*100))
tmp[`2.5 %`<0, `2.5 %` := 0]
tmp <- tmp[, lapply(.SD, function(x) format(x, digits=0, nsmall=1, scientific=F))]
...
tmp[, `:=`(
  croparea_3clas = factor(rep(levels(eth$croparea_3clas), each=1, 5), levels=c("<= 2 ha", "2-4 ha", "> 4 ha")),
  class5 = factor(rep(levels(eth$class5), each=3, 1), levels=levels(eth$class5))
  )]
...
# ESS2
tmp <- svymean(~I(interaction(croparea_3clas, class5)), eth.svy.farm[["eth2"]], na.rm=T)
tmp.cv <- confint(tmp)
tmp <- cbind(as.data.table(tmp*100), as.data.table(tmp.cv*100))
tmp[`2.5 %`<0, `2.5 %` := 0]
tmp <- tmp[, lapply(.SD, function(x) format(x, digits=0, nsmall=1, scientific=F))]
...
# ERSS1
tmp <- svymean(~I(interaction(croparea_3clas, class5)), eth.svy.farm[["eth1"]], na.rm=T)
tmp.cv <- confint(tmp)
tmp <- cbind(as.data.table(tmp*100), as.data.table(tmp.cv*100))
tmp[`2.5 %`<0, `2.5 %` := 0]
tmp <- tmp[, lapply(.SD, function(x) format(x, digits=0, nsmall=1, scientific=F))]
...
tmp1 <- lapply(eth.svy.shf, function(x) {
  ...
  tmp <- tmp[, lapply(.SD, function(x) format(x, digits=0, nsmall=1, scientific=F))]
  tmp[, CI := paste(`2.5 %`, `97.5 %`, sep=" - ")]
  tmp[, `:=`(class5 = factor(levels(eth$class5), labels=levels(eth$class5)))]
})
tmp <- rbindlist(tmp1)
tmp2 <- c("2013/2014", "2011/2012")
...
# ESS3
tmp <- svymean(~I(interaction(seg_quad, class5)), eth.svy.farm[["eth3"]], na.rm=T)
tmp.cv <- confint(tmp)
tmp <- cbind(as.data.table(tmp*100), as.data.table(tmp.cv*100))
tmp[`2.5 %`<0, `2.5 %` := 0]
tmp <- tmp[, lapply(.SD, function(x) format(x, digits=0, nsmall=1, scientific=F))]
...
tmp[, `:=`(
  ...
  class5 = factor(rep(levels(eth$class5), each=4, 1), levels=levels(eth$class5))
  )]
...
# ESS2
tmp <- svymean(~I(interaction(seg_quad, class5)), eth.svy.farm[["eth2"]], na.rm=T)
tmp.cv <- confint(tmp)
tmp <- cbind(as.data.table(tmp*100), as.data.table(tmp.cv*100))
tmp[`2.5 %`<0, `2.5 %` := 0]
tmp <- tmp[, lapply(.SD, function(x) format(x, digits=0, nsmall=1, scientific=F))]
...
# ERSS1
tmp <- svymean(~I(interaction(seg_quad, class5)), eth.svy.farm[["eth1"]], na.rm=T)
tmp.cv <- confint(tmp)
tmp <- cbind(as.data.table(tmp*100), as.data.table(tmp.cv*100))
tmp[`2.5 %`<0, `2.5 %` := 0]
tmp <- tmp[, lapply(.SD, function(x) format(x, digits=0, nsmall=1, scientific=F))]
...
# ESS3
tmp <- svymean(~I(interaction(seg_quad, class5)), eth.svy.shf[["eth3"]], na.rm=T)
tmp.cv <- confint(tmp)
tmp <- cbind(as.data.table(tmp*100), as.data.table(tmp.cv*100))
tmp[`2.5 %`<0, `2.5 %` := 0]
tmp <- tmp[, lapply(.SD, function(x) format(x, digits=0, nsmall=1, scientific=F))]
...
# ESS2
tmp <- svymean(~I(interaction(seg_quad, class5)), eth.svy.shf[["eth2"]], na.rm=T)
tmp.cv <- confint(tmp)
tmp <- cbind(as.data.table(tmp*100), as.data.table(tmp.cv*100))
tmp[`2.5 %`<0, `2.5 %` := 0]
tmp <- tmp[, lapply(.SD, function(x) format(x, digits=0, nsmall=1, scientific=F))]
...
# ERSS
tmp <- svymean(~I(interaction(seg_quad, class5)), eth.svy.shf[["eth1"]], na.rm=T)
tmp.cv <- confint(tmp)
tmp <- cbind(as.data.table(tmp*100), as.data.table(tmp.cv*100))
tmp[`2.5 %`<0, `2.5 %` := 0]
tmp <- tmp[, lapply(.SD, function(x) format(x, digits=0, nsmall=1, scientific=F))]
