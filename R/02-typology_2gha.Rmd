...
```{r gha-prop9, fig.cap="Est. Proportions of Farm Holdings across Farm Sizes and Categories", dev="png"}
...
table_options(HTMLcaption="(#tab:proptab55) Est. Proportions of Farm Holdings across Categories (GLSS6, 2005/06, percent)")
html(tabular(Heading("Farm Size")*croparea_3clas*(mean+CI)~Heading("Farm Types")*class5*Heading()*identity,
  data=tmp), rmarkdown=T)
...
table_options(HTMLcaption="(#tab:proptab54) Est. Proportions of Farm Holdings across Categories (GLSS6, 1998/99, percent)")
html(tabular(Heading("Farm Size")*croparea_3clas*(mean+CI)~Heading("Farm Types")*class5*Heading()*identity,
  data=tmp), rmarkdown=T)
