...
GLSS collect information on the demographic characteristics of the population, their education, health, employment and time use, migration, housing conditions and household agriculture, with a specific focus on **labor force**, with a labour force module expanded in GLSS6 to include a section on child labor.
...
```{r gha-prop9, fig.cap="Est. Proportions of Farm Holdings across Farm Sizes and Categories"}
...
```{r gha-prop5, fig.cap="Est. Proportions of Farm Holdings across Farm Sizes and Categories", dev="png"}
