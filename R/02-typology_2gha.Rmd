...
# GLSS6
tmp <- svyCrossProp(c("croparea_3clas", "cropsales_3clas", "naggross_3clas"), gha.svy.farm[["gha6"]])
...
# GLSS5
tmp <- svyCrossProp(c("croparea_3clas", "cropsales_3clas", "naggross_3clas"), gha.svy.farm[["gha5"]])
...
# GLSS4
tmp <- svyCrossProp(c("croparea_3clas", "cropsales_3clas", "naggross_3clas"), gha.svy.farm[["gha4"]])
...
# GLSS6
tmp <- svyCrossProp(c("croparea_3clas", "class5"), gha.svy.farm[["gha6"]])
...
# GLSS5
tmp <- svyCrossProp(c("croparea_3clas", "class5"), gha.svy.farm[["gha5"]])
...
# GLSS4
tmp <- svyCrossProp(c("croparea_3clas", "class5"), gha.svy.farm[["gha4"]])
...
tmp1 <- lapply(gha.svy.shf, function(x) svyCrossProp("class5", x))
tmp <- rbindlist(tmp1)
...
# GLSS6
tmp <- svyCrossProp(c("seg_quad", "class5"), gha.svy.farm[["gha6"]])
...
# GLSS5
tmp <- svyCrossProp(c("seg_quad", "class5"), gha.svy.farm[["gha5"]])
...
# GLSS4
tmp <- svyCrossProp(c("seg_quad", "class5"), gha.svy.farm[["gha4"]])
...
# GLSS6
tmp <- svyCrossProp(c("seg_quad", "class5"), gha.svy.shf[["gha6"]])
...
# GLSS5
tmp <- svyCrossProp(c("seg_quad", "class5"), gha.svy.shf[["gha5"]])
...
# GLSS4
tmp <- svyCrossProp(c("seg_quad", "class5"), gha.svy.shf[["gha4"]])
